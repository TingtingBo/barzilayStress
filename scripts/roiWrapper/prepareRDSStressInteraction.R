...
stress.data <- stress.data[which(stress.data$Cummulative_Stress_Load_No_Rape>=1),]
...
demoOfInterest <- c('bblid', 'scanid', 'ageAtScan1', 'sex', 'averageManualRating', 't1Exclude', 'Cummulative_Stress_Load_No_Rape', 'race2', 'PTSD')
...
saveRDS(t1.cov, "/data/joy/BBL/projects/barzilayStress/data/t1CovIN.RDS")

# Now do the cbf data
demoOfInterest <- c('bblid', 'scanid', 'ageAtScan1', 'sex', 'pcaslTSNR', 'pcaslExclude', 'Cummulative_Stress_Load_No_Rape', 'race2', 'PTSD')
...
saveRDS(cbf.cov, "/data/joy/BBL/projects/barzilayStress/data/cbfCovIN.RDS")

# Now do reho 
demoOfInterest <- c('bblid', 'scanid', 'ageAtScan1', 'sex', 'restRelMeanRMSMotion', 'restExclude', 'Cummulative_Stress_Load_No_Rape', 'race2', 'PTSD')
...
saveRDS(rest.cov, "/data/joy/BBL/projects/barzilayStress/data/restCovIN.RDS")

# Now do DTI
demoOfInterest <- c('bblid', 'scanid', 'ageAtScan1', 'sex', 'dti64Tsnr', 'dti64Exclude', 'Cummulative_Stress_Load_No_Rape', 'race2', 'PTSD')
...
saveRDS(dti.cov, "/data/joy/BBL/projects/barzilayStress/data/dtiCovIN.RDS")
...
dti.cov$race2 <- as.factor(dti.cov$race2)
dti.cov$dti64Exclude <- binary.flip(dti.cov$dti64Exclude)
saveRDS(dti.cov, "/data/joy/BBL/projects/barzilayStress/data/faCovIN.RDS")
