...
demoOfInterest <- c('bblid', 'scanid', 'ageAtScan1', 'sex', 'averageManualRating', 't1Exclude', 'Cummulative_Stress_Load_No_Rape', 'race2', 'Overall_Psychopathology_ar', 'envSES', 'Anxious_Misery_ar','healthExcludev2')
...
t1.cov$t1Exclude[t1.cov$healthExcludev2==1] <- 0
t1.cov$t1Exclude2 <- 0
...
# Now do the cbf data
demoOfInterest <- c('bblid', 'scanid', 'ageAtScan1', 'sex', 'pcaslTSNR', 'pcaslExclude', 'Cummulative_Stress_Load_No_Rape', 'race2', 'Overall_Psychopathology_ar', 'envSES', 'Anxious_Misery_ar', 'healthExcludev2')
...
cbf.cov$cbfExclude[cbf.cov$healthExcludev2==1] <- 0
...
# Now do reho 
demoOfInterest <- c('bblid', 'scanid', 'ageAtScan1', 'sex', 'restRelMeanRMSMotion', 'restExclude', 'Cummulative_Stress_Load_No_Rape', 'race2', 'Overall_Psychopathology_ar', 'envSES', 'Anxious_Misery_ar', 'healthExcludev2')
...
rest.cov$restExclude[rest.cov$healthExcludev2==1] <- 0
...
# Now do DTI
demoOfInterest <- c('bblid', 'scanid', 'ageAtScan1', 'sex', 'dti64Tsnr', 'dti64Exclude', 'Cummulative_Stress_Load_No_Rape', 'race2', 'Overall_Psychopathology_ar', 'envSES', 'Anxious_Misery_ar', 'healthExcludev2')
...
dti.cov$t1Exclude[dti.cov$healthExcludev2==1] <- 0
